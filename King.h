...
public:
    ...
    virtual std::vector<std::shared_ptr<Piece>> legal_movesWhite(std::shared_ptr<Piece>& destination);
    virtual std::vector<std::shared_ptr<Piece>> legal_movesBlack(std::shared_ptr<Piece>& destination);
