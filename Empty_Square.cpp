...
Empty_Square::Empty_Square(int x, int y, bool isWhite, bool isEmpty, std::shared_ptr<sf::Texture> texture)
    ...
    std::vector<std::shared_ptr<Piece>> Empty_Square::legal_movesWhite() { std::cout << "EmptySquare fnc\n";  return std::vector<std::shared_ptr<Piece>>(); }
    std::vector<std::shared_ptr<Piece>> Empty_Square::legal_movesBlack() { std::cout << "EmptySquare fnc\n"; return std::vector<std::shared_ptr<Piece>>(); }
    bool isEmpty;
    int x;
    int y;
    bool selected = false;
