...
Empty_Square::Empty_Square(int x, int y, bool isWhite, bool isEmpty, std::shared_ptr<sf::Texture> texture)
    ...
    std::vector<std::pair<int, int>> Empty_Square::legal_movesWhite(const Board& tempBoard) {
        //std::cout << "EmptySquare fnc\n";
        std::vector<std::pair<int, int>> pair;
        return pair; }
    std::vector<std::pair<int, int>> Empty_Square::legal_movesBlack(const Board& tempBoard) {
     //   std::cout << "EmptySquare fnc\n";
        std::vector<std::pair<int, int>> pair;
        return pair; }
    bool isEmpty;
